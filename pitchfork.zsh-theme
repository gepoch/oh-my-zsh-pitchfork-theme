...
%{$fg_bold[cyan]%}├$LEFT_PADDING%{$reset_color%}%{$fg[cyan]%}"
  ...
  # Langage specific prompt info.
    ZSH_THEME_VIRTUALENV_PROMPT_PREFIX="$PRE_PREFIX"'env'"$POST_PREFIX"
    ZSH_THEME_VIRTUALENV_PROMPT_SUFFIX="$SUFFIX"
    ZSH_THEME_VIRTUALENV_PROMPT_DIRTY=""
    ZSH_THEME_VIRTUALENV_PROMPT_CLEAN=""
